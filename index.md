...
<input id="searchbar" onkeyup="search_animal()" type="text"
        name="search" placeholder="Search ...@icn-camera" style="width:55vw;border-radius:6px;height:4.5vh"><button type="submit"><button class="btn btn-secondary" type="button">
