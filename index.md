...
<input id="searchbar" onkeyup="search_animal()" type="text"
        name="search" placeholder="Search ..." style="width:55vw;border-radius:6px;height:4.5vh"><button type="submit">![image](https://user-images.githubusercontent.com/63045639/118499561-ae02a480-b744-11eb-83d7-7d659dbbaa0a.png)
